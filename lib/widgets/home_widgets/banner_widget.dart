...
class BannerCarousel extends StatelessWidget {
    ...
    return SizedBox(
      ...
      child: CarouselSlider.builder(
        ...
        itemBuilder: (context, index, realIndex) {
          ...
          final borderRadius = BorderRadius.circular(cardStyle['borderRadius']?.toDouble() ?? 20.0);
                ...
                if (banner['badge'] != null)
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: _parseColor(banner['badge']['color']) ?? Colors.red,
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontSize: titleStyle['fontSize']?.toDouble() ?? 28,
                      ...
                      Text(
                        banner['subtitle'] ?? '',
                        style: TextStyle(
                          color: _parseColor(subtitleStyle['color']) ?? Colors.white70,
  ...
  Color? _parseColor(String? colorString) {
    ...
    if (colorString.startsWith('rgba')) {
      final rgba = colorString.replaceAll(RegExp(r'rgba|\(|\)|\s'), '').split(',');
      if (rgba.length == 4) {
